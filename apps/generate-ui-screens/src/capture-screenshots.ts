...
// Mobile-only capture matrix (8 combinations — phone + tablet, light + dark, en + es).
// CSS viewport and DPR match the ACTUAL Android WebView values so golden PNGs
// have the same layout AND pixel dimensions as device screenshots. No resize needed.
//
// Pixel 6: 412×867 CSS at 2.625 DPR → 1081×2276 px output
// Tablet: TODO — measure from real tablet emulator when available
const PIXEL6_VP = { width: 412, height: 867 };
const PIXEL6_DPR = 2.625;

const PROJECTS: CaptureProject[] = [
  // Phone (Pixel 6 WebView: 412×867 CSS, 2.625 DPR)
  { name: "phone-light-en", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "light", locale: "en" },
  { name: "phone-light-es", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "light", locale: "es" },
  { name: "phone-dark-en", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "dark", locale: "en" },
  { name: "phone-dark-es", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "dark", locale: "es" },
  // Tablet (TODO: measure from real tablet emulator)
  { name: "tablet-light-en", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "light", locale: "en" },
  { name: "tablet-light-es", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "light", locale: "es" },
  { name: "tablet-dark-en", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "dark", locale: "en" },
  { name: "tablet-dark-es", viewport: PIXEL6_VP, deviceScaleFactor: PIXEL6_DPR, theme: "dark", locale: "es" },
];

// // Archived full multi-variant matrix (24 combinations — including desktop):
// const PROJECTS: CaptureProject[] = [
//   // Desktop (native app)
